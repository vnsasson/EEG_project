...
%% 9- saving dataset to library - optional for automatic saving of the dataset 
 
% saving before component removing
EEG = pop_saveset( EEG, 'filename',file_name,'filepath','C:\\Users\\sasso\\Desktop\\Studies\\Project\\B- Brain activity during reading\\datasets\\before_try\\');
EEG = eeg_checkset( EEG );
...
% saving after component removing
EEG = pop_saveset( EEG, 'filename',file_name,'filepath','C:\\Users\\sasso\\Desktop\\Studies\\Project\\B- Brain activity during reading\\datasets\\after_try\\');
EEG = eeg_checkset( EEG );
