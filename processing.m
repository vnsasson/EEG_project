...
% import each of the subjects

% File -> Load existing dataset -> choose dataset to load
 
pause 

%%

PSD_length = 257; % calculated before
fs = 500;
...
writematrix(export_T,'C:\Users\sasso\Desktop\Studies\Project\B- Brain activity during reading\eeglab2020_0\excel_mat\inc_gamma\Reding_screen_39.2019_15.10.19.xlsx');
